        ...
        <div>
            ...
            <div className="space-y-6">
                ...
                <label className="flex items-center gap-4 p-6 border-2 border-[#e5e7eb] rounded-sm hover:border-[#d1d5db] cursor-pointer transition-all">
                    <input
                        type="checkbox"
                        checked={planData.preferences.isRainyDay}
                        onChange={(e) =>
                            setPlanData({
                                ...planData,
                                preferences: { ...planData.preferences, isRainyDay: e.target.checked }
                            })
                        }
                        className="w-5 h-5"
                    />
                ...
                <div className="p-6 border-2 border-[#e5e7eb] rounded-sm">
                    <div className="flex items-center gap-3 mb-4">
                        <span className="text-[#111827] font-medium">
                            תקציב מקסימלי: {planData.preferences.maxPrice}
                        </span>
                    </div>
                    ...
                    <input
                        ...
                        max={1000}
                        step={10}
                        value={planData.preferences.maxPrice ?? 0}
                        onChange={(e) =>
                            setPlanData({
                                ...planData,
                                preferences: { ...planData.preferences, maxPrice: Number(e.target.value) }
                            })
                        }
                ...
                <div className="p-6 border-2 border-[#e5e7eb] rounded-sm">
                    ...
                    <input
                        type="number"
                        min={1}
                        value={planData.preferences.availableHours ?? 0}
                        onChange={(e) =>
                            setPlanData({
                                ...planData,
                                preferences: { ...planData.preferences, availableHours: Number(e.target.value) }
                            })
                        }
