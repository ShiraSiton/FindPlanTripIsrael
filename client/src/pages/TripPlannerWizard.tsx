...
export default function TripPlannerWizard() {
    ...
    const handleFindTrips = async () => {
        console.log("handleFindTrips clicked! planData:", planData);
        try {
            console.log("Dispatching fetchRecommendedTrips...");
            await dispatch(fetchRecommendedTrips(planData)).unwrap();
            console.log("After dispatch, navigating...");
    ...
    const renderStepContent = () => {
        switch (currentStep) {
            ...
            case 3:
                return (
                    <TripTypeSelection
                        value={planData.tripType}
                        onChange={(val) =>
                            setPlanData({ ...planData, tripType: val })
                        }
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-[#111827] font-medium">
                                            {
                                                lookups?.regions?.find(r => r.id === planData.region)
                                                    ?.regionName
                                            }
                                        </div>
                                    </div>
                            ...
                            {planData.tripType && (
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-[#111827] font-medium">
                                            {
                                                lookups?.tripTypes?.find(t => t.id === planData.tripType)
                                                    ?.typeName
                                            }
                                        </div>
                                    </div>
    ...
    return (
        <div className="min-h-screen bg-[#ffffff] pt-20" dir="rtl">
            {/* Hero Header */}
