...
import { fetchTripById, setCurrentTrip } from "../redux/slices/tripsSlice"
...
export default function TripDetailsPage() {
    ...
    const { currentTrip, trips, loading } = useAppSelector(state => state.trips)
    ...
    useEffect(() => {
        ...
        if (existingTrip) {
            dispatch(setCurrentTrip(existingTrip))
        }
        else {
